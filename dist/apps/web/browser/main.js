...
class DefaultContainerComponent extends _core_shared__WEBPACK_IMPORTED_MODULE_1__.BBDBaseComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      styles: [".nav-bar[_ngcontent-%COMP%] {\n  position: fixed;\n  z-index: 10;\n  display: flex;\n  width: 100%;\n  align-items: flex-start;\n  justify-content: space-between;\n  padding: 1rem;\n}\n\n.nav-link[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  border-radius: 9999px;\n  padding-left: 1rem;\n  padding-right: 1rem;\n  padding-top: 0.5rem;\n  padding-bottom: 0.5rem;\n}\n.nav-link[_ngcontent-%COMP%]   .material-symbols-rounded[_ngcontent-%COMP%] {\n  font-size: 1.25rem;\n}\n\n.avatar-btn[_ngcontent-%COMP%] {\n  display: flex;\n  min-width: -moz-fit-content;\n  min-width: fit-content;\n  cursor: pointer;\n  align-items: center;\n}\n.avatar-btn[_ngcontent-%COMP%]   .user[_ngcontent-%COMP%] {\n  display: flex;\n  height: 2.25rem;\n  width: 2.25rem;\n  min-width: 2rem;\n  align-items: center;\n  justify-content: center;\n  border-radius: 9999px;\n  --tw-bg-opacity: 1;\n  background-color: rgb(186 230 253 / var(--tw-bg-opacity, 1));\n  font-weight: 700;\n  --tw-text-opacity: 1;\n  color: rgb(2 132 199 / var(--tw-text-opacity, 1));\n  font-size: 0.875rem;\n}\n\n.main-container[_ngcontent-%COMP%] {\n  position: relative;\n  padding-top: 8rem;\n  padding-bottom: 1.25rem;\n}\n@media screen and (min-width: 1024px) {\n  .main-container[_ngcontent-%COMP%] {\n    min-height: calc(100svh - 20.8rem);\n  }\n}\n.main-container[_ngcontent-%COMP%]:has(.hero) {\n  padding-top: 0px;\n}\n\n.mat-sidenav[_ngcontent-%COMP%] {\n  --tw-bg-opacity: 1;\n  background-color: rgb(250 250 249 / var(--tw-bg-opacity, 1));\n  min-width: 15rem;\n}\n\n.mat-drawer[_ngcontent-%COMP%]:not(.mat-drawer-side) {\n  --tw-shadow: 0 0 #0000;\n  --tw-shadow-colored: 0 0 #0000;\n  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);\n}\n\n.menu-button[_ngcontent-%COMP%]   .material-symbols-rounded[_ngcontent-%COMP%] {\n  width: 1.5rem;\n  opacity: 1;\n  transition: all 0.3s ease;\n}\n.menu-button[_ngcontent-%COMP%]   .material-symbols-rounded.hide[_ngcontent-%COMP%] {\n  width: 0px;\n  opacity: 0;\n}\n\nmat-sidenav-container[_ngcontent-%COMP%] {\n  flex: 1 1 auto;\n}\nmat-sidenav-container[_ngcontent-%COMP%]:has(.mat-drawer-opened) {\n  height: 100svh;\n  overflow: auto;\n}\n\n.sidemenu-inner[_ngcontent-%COMP%] {\n  margin-top: 8rem;\n}\n\n.sidemenu-inner[_ngcontent-%COMP%]    > [_ngcontent-%COMP%]:not([hidden])    ~ [_ngcontent-%COMP%]:not([hidden]) {\n  --tw-divide-y-reverse: 0;\n  border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse)));\n  border-bottom-width: calc(1px * var(--tw-divide-y-reverse));\n  border-color: rgb(0 0 0 / 0.3);\n}\n\n@media (min-width: 321px) {\n\n  .sidemenu-inner[_ngcontent-%COMP%] {\n    margin-top: 10rem;\n  }\n}\n.sidemenu-inner[_ngcontent-%COMP%]   .btn-stroke-white[_ngcontent-%COMP%] {\n  margin-right: auto;\n  width: 100%;\n  max-width: 24rem;\n}\n\n.menu-button[_ngcontent-%COMP%]   .material-symbols-rounded[_ngcontent-%COMP%] {\n  width: 1.5rem;\n  opacity: 1;\n  transition: all 0.3s ease;\n}\n.menu-button[_ngcontent-%COMP%]   .material-symbols-rounded.hide[_ngcontent-%COMP%] {\n  width: 0px;\n  opacity: 0;\n}\n\n.sidenav-container[_ngcontent-%COMP%] {\n  width: 100%;\n  background-color: rgb(240 249 255 / 0.3);\n  padding-left: 2rem;\n  padding-right: 2rem;\n  padding-top: 1rem;\n  padding-bottom: 1rem;\n  --tw-backdrop-blur: blur(24px);\n  -webkit-backdrop-filter: var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);\n  backdrop-filter: var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);\n}\n\n.social-icon-wrap[_ngcontent-%COMP%] {\n  margin-top: 1.25rem;\n  display: flex;\n  width: 100%;\n  align-items: center;\n  justify-content: flex-start;\n}\n\n.social-icon-wrap[_ngcontent-%COMP%]    > [_ngcontent-%COMP%]:not([hidden])    ~ [_ngcontent-%COMP%]:not([hidden]) {\n  --tw-space-x-reverse: 0;\n  margin-right: calc(0.5rem * var(--tw-space-x-reverse));\n  margin-left: calc(0.5rem * calc(1 - var(--tw-space-x-reverse)));\n}\n\n@media (min-width: 768px) {\n\n  .social-icon-wrap[_ngcontent-%COMP%] {\n    max-width: 24rem;\n  }\n}\n.social-icon-wrap[_ngcontent-%COMP%]   .divider[_ngcontent-%COMP%] {\n  flex: 1 1 auto;\n  border-top-width: 1px;\n  border-color: rgb(255 255 255 / 0.5);\n}\n.social-icon-wrap[_ngcontent-%COMP%]    > a[_ngcontent-%COMP%] {\n  display: flex;\n  height: 2.75rem;\n  width: 2.75rem;\n  align-items: center;\n  padding: 0.5rem;\n}\n\n.sidenav-list[_ngcontent-%COMP%] {\n  padding-top: 0.75rem;\n  padding-bottom: 0.75rem;\n}\n.sidenav-list[_ngcontent-%COMP%]   a[_ngcontent-%COMP%], .sidenav-list[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  display: block;\n  padding-left: 0.25rem;\n  padding-right: 0.25rem;\n  padding-top: 0.75rem;\n  padding-bottom: 0.75rem;\n  font-size: 1rem;\n}\n\n.web-map[_ngcontent-%COMP%] {\n  margin-top: 1.25rem;\n}\n\n.web-map[_ngcontent-%COMP%]    > [_ngcontent-%COMP%]:not([hidden])    ~ [_ngcontent-%COMP%]:not([hidden]) {\n  --tw-space-y-reverse: 0;\n  margin-top: calc(0.75rem * calc(1 - var(--tw-space-y-reverse)));\n  margin-bottom: calc(0.75rem * var(--tw-space-y-reverse));\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 90310);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ 80489);
/* harmony import */ var _core_shared__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @core/shared */ 76777);
...
/* harmony import */ var swiper_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! swiper/angular */ 38585);
...
function PartnerLogosComponent_1_ng_template_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const sponsor_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]().$implicit;
    const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("src", ctx_r2.combineCdnUrl(sponsor_r1.logoFullPath || ""), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsanitizeUrl"])("alt", sponsor_r1.name);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](sponsor_r1.desc);
  }
}
function PartnerLogosComponent_1_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](0, PartnerLogosComponent_1_ng_template_0_Template, 4, 3, "ng-template", 2);
  }
}
class PartnerLogosComponent extends _core_shared__WEBPACK_IMPORTED_MODULE_0__.BBDBaseComponent {
  constructor(injector) {
    super(injector);
    this.injector = injector;
    this._appMsgApiServ = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.inject)(_core_services__WEBPACK_IMPORTED_MODULE_1__.AppMsgApiServ);
    this.sponsors = [];
    this.swiperConfig = {
      slidesPerView: 5,
      spaceBetween: 30,
  ...
  getCaches() {
    (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.forkJoin)([this._appMsgApiServ.getSponsorViews()]).subscribe(([sponsors]) => {
      this.sponsors = sponsors;
    });
  }
  static {
    this.ɵfac = function PartnerLogosComponent_Factory(t) {
      return new (t || PartnerLogosComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_2__.Injector));
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      template: function PartnerLogosComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, PartnerLogosComponent_1_Template, 1, 0, null, 1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        }
        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("config", ctx.swiperConfig);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngForOf", ctx.sponsors);
        }
      },
      dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.NgForOf, swiper_angular__WEBPACK_IMPORTED_MODULE_5__.SwiperComponent, swiper_angular__WEBPACK_IMPORTED_MODULE_5__.SwiperSlideDirective],
      styles: ["/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsInNvdXJjZVJvb3QiOiIifQ== */"]
    });
  }
}
...
class CompleteComponent extends _core_shared__WEBPACK_IMPORTED_MODULE_0__.BBDBaseComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      styles: ["\n\nsvg[_ngcontent-%COMP%] {\n  margin-right: 1rem;\n  margin-bottom: 1rem;\n  display: block;\n  width: 5rem;\n}\n@media (min-width: 1280px) {\n  svg[_ngcontent-%COMP%] {\n    width: 6rem;\n  }\n}\n@media (min-width: 1600px) {\n  svg[_ngcontent-%COMP%] {\n    width: 8rem;\n  }\n}\n\n.path[_ngcontent-%COMP%] {\n  stroke-dasharray: 1000;\n  stroke-dashoffset: 0;\n}\n.path.circle[_ngcontent-%COMP%] {\n  animation: _ngcontent-%COMP%_dash 0.9s ease-in-out;\n}\n.path.line[_ngcontent-%COMP%] {\n  stroke-dashoffset: 1000;\n  animation: _ngcontent-%COMP%_dash 0.9s 0.35s ease-in-out forwards;\n}\n.path.check[_ngcontent-%COMP%] {\n  stroke-dashoffset: -100;\n  animation: _ngcontent-%COMP%_dash-check 0.9s 0.35s ease-in-out forwards;\n}\n\n.complete-title[_ngcontent-%COMP%] {\n  margin-top: 0.25rem;\n  font-size: 4.5rem;\n  letter-spacing: 0.025em;\n  color: var(--md-sys-color-primary);\n}\n\n.fade-in-left[_ngcontent-%COMP%] {\n  --tw-translate-x: -2.5rem;\n  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));\n  opacity: 0;\n  transition-delay: 200ms;\n  animation: _ngcontent-%COMP%_fadeInLeft 1s ease-out forwards; \n\n}\n\n@keyframes _ngcontent-%COMP%_fadeInLeft {\n  from {\n    opacity: 0;\n    transform: translateX(-50px);\n  }\n  to {\n    opacity: 1;\n    transform: translateX(0); \n\n  }\n}\n@keyframes _ngcontent-%COMP%_dash {\n  0% {\n    stroke-dashoffset: 1000;\n  }\n  100% {\n    stroke-dashoffset: 0;\n  }\n}\n@keyframes _ngcontent-%COMP%_dash-check {\n  0% {\n    stroke-dashoffset: -100;\n  }\n  100% {\n    stroke-dashoffset: 900;\n  }\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
class FailComponent extends _core_shared__WEBPACK_IMPORTED_MODULE_0__.BBDBaseComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      styles: ["\n\nsvg[_ngcontent-%COMP%] {\n  margin-right: 1rem;\n  margin-bottom: 1rem;\n  display: block;\n  width: 5rem;\n}\n@media (min-width: 1280px) {\n  svg[_ngcontent-%COMP%] {\n    width: 6rem;\n  }\n}\n@media (min-width: 1600px) {\n  svg[_ngcontent-%COMP%] {\n    width: 8rem;\n  }\n}\n\n.path[_ngcontent-%COMP%] {\n  stroke-dasharray: 1000;\n  stroke-dashoffset: 0;\n}\n.path.circle[_ngcontent-%COMP%] {\n  animation: _ngcontent-%COMP%_dash 0.9s ease-in-out;\n}\n.path.x-line-1[_ngcontent-%COMP%] {\n  stroke-dashoffset: 1000;\n  animation: _ngcontent-%COMP%_dash 0.9s 0.35s ease-in-out forwards;\n}\n.path.x-line-2[_ngcontent-%COMP%] {\n  stroke-dashoffset: 1000;\n  animation: _ngcontent-%COMP%_dash 0.9s 0.5s ease-in-out forwards;\n}\n\n.fail-title[_ngcontent-%COMP%] {\n  margin-top: 0.25rem;\n  font-size: 4.5rem;\n  letter-spacing: 0.025em;\n  color: var(--md-sys-color-error);\n}\n\n.fade-in-left[_ngcontent-%COMP%] {\n  --tw-translate-x: -2.5rem;\n  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));\n  opacity: 0;\n  transition-delay: 200ms;\n  animation: _ngcontent-%COMP%_fadeInLeft 1s ease-out forwards;\n}\n\n@keyframes _ngcontent-%COMP%_fadeInLeft {\n  from {\n    opacity: 0;\n    transform: translateX(-50px);\n  }\n  to {\n    opacity: 1;\n    transform: translateX(0);\n  }\n}\n@keyframes _ngcontent-%COMP%_dash {\n  0% {\n    stroke-dashoffset: 1000;\n  }\n  100% {\n    stroke-dashoffset: 0;\n  }\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
class PendingComponent extends _core_shared__WEBPACK_IMPORTED_MODULE_0__.BBDBaseComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      styles: ["\n\nsvg[_ngcontent-%COMP%] {\n  margin-right: 1rem;\n  margin-bottom: 1rem;\n  display: block;\n  width: 5rem;\n}\n@media (min-width: 1280px) {\n  svg[_ngcontent-%COMP%] {\n    width: 6rem;\n  }\n}\n@media (min-width: 1600px) {\n  svg[_ngcontent-%COMP%] {\n    width: 8rem;\n  }\n}\n\n.path[_ngcontent-%COMP%] {\n  stroke-dasharray: 1000;\n  stroke-dashoffset: 0;\n}\n.path.hour-hand[_ngcontent-%COMP%] {\n  transform-origin: 80px 80px;\n  animation: _ngcontent-%COMP%_dash 0.9s ease-in-out, _ngcontent-%COMP%_tick-hour 6s linear infinite;\n}\n.path.minute-hand[_ngcontent-%COMP%] {\n  transform-origin: 80px 80px;\n  animation: _ngcontent-%COMP%_dash 0.9s ease-in-out, _ngcontent-%COMP%_tick-minute 1s linear infinite;\n}\n\n.pending-title[_ngcontent-%COMP%] {\n  margin-top: 0.25rem;\n  font-size: 4.5rem;\n  letter-spacing: 0.025em;\n  color: var(--md-sys-color-surface-tint);\n}\n\n.fade-in-left[_ngcontent-%COMP%] {\n  --tw-translate-x: -2.5rem;\n  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));\n  opacity: 0;\n  transition-delay: 200ms;\n  animation: _ngcontent-%COMP%_fadeInLeft 1s ease-out forwards;\n}\n\n@keyframes _ngcontent-%COMP%_fadeInLeft {\n  from {\n    opacity: 0;\n    transform: translateX(-50px);\n  }\n  to {\n    opacity: 1;\n    transform: translateX(0);\n  }\n}\n@keyframes _ngcontent-%COMP%_tick-hour {\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n}\n@keyframes _ngcontent-%COMP%_tick-minute {\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n}\n@keyframes _ngcontent-%COMP%_dash {\n  0% {\n    stroke-dashoffset: 1000;\n  }\n  100% {\n    stroke-dashoffset: 0;\n  }\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
class SEOServ {
  ...
  initMetaTags() {
    ...
    this.meta.addTags([{
      ...
      name: 'keywords',
      content: '台灣人工智慧檢驗醫學學會,人工智慧,檢驗醫學'
    }, {
      name: 'description',
      content: this.appEnv.siteName
    }]);
...
function Payment407ReceiptPrintComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](7, "\u53F0\u7063\u4EBA\u5DE5\u667A\u6167\u6AA2\u9A57\u91AB\u5B78\u5B78\u6703");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();

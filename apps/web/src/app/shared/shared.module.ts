...
import { GlassBgComponent, SkeletonLoaderComponent, PaginatorComponent, ResultEmptyComponent, CompleteComponent } from './components';
...
const CUST_COMPONENTS = [
  GlassBgComponent, SkeletonLoaderComponent, PaginatorComponent, ResultEmptyComponent, CompleteComponent
];
